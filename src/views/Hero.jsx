  ...
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        ...
        <SVG icon="box" width={48} fill={colors.red} left="60%" top="70%" />
        <SVG icon="box" width={6} fill={colors['grey-darker']} left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="triangle" hiddenMobile width={16} stroke={colors['blue-dark']} left="80%" top="10%" />
        <SVG icon="triangle" width={12} stroke={colors['grey-darkest']} left="90%" top="50%" />
        ...
        <SVG icon="circle" hiddenMobile width={8} fill={colors['grey-darkest']} left="45%" top="10%" />
      </UpDownWide>
      ...
      <SVG icon="triangle" width={8} stroke={colors['grey-darkest']} left="95%" top="90%" />
      <SVG icon="box" hiddenMobile width={24} fill={colors['grey-darker']} left="40%" top="80%" />
      <SVG icon="triangle" width={8} stroke={colors['grey-darker']} left="25%" top="5%" />
      <SVG icon="circle" hiddenMobile width={64} fill={colors.green} left="55%" top="-10%" />
